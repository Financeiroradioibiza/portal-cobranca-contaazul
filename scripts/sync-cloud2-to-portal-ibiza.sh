...
for f in ingest.ts audio.ts vinheta.ts publicar.ts enriquecer-tags.ts apagar-musica.ts player-registry.ts publishCronogramas.ts tagEnrichmentCore.ts; do
