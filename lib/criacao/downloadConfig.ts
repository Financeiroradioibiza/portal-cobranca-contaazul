...
export function providerConfigHint(provider: DownloadProviderId): string {
  switch (provider) {
    ...
    case "deemix":
      return "Configure CRIACAO_DEEMIX_ARL no cloud2 (cookie arl do deezer.com). Downloads em 320 kbps (Premium); override com CRIACAO_DEEMIX_BITRATE (1=128k, 3=320k, 9=FLAC).";
    case "youtube":
