...
/** Limpa sufixos de filename (~2, .mp3) e espaços. */
...
/** Primeiro « - » separa artista do resto (título pode ter mais hífens). */
...
/** Resolve texto «Artista - Música» para URL canônica Deezer; exige match de artista. */
