...
export const CRIACAO_SIDEBAR = [
  ...
  { href: "/criacao/vinhetas", label: "Vinhetas", icon: "📣", soon: true },
  { href: "/criacao/cronograma", label: "Cronograma", icon: "🗓️", soon: true },
  { href: "/criacao/wizard", label: "Wizard IA", icon: "✨", soon: true },
] as const;
